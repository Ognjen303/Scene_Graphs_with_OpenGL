...
public class OpenGLApplication {
	...
	public void initialize() throws Exception {
		...
		if (glfwInit() != true) // Initialises OpenGL, glfw: graphics library framework
		...
		// Enable v-sync, synchronizes image frame rate of application with display monitor
		// refresh rate
		glfwSwapInterval(1);

		// Cull back-faces of polygons
		// stops the triangles that are facing away from camera from being drawn
		...
		// Camera enables panning around the scene
		...
		// instance of CubeRobot is created
	...
	public void render() {
		...
		// If we didn't do this step, we would re-draw over previous frame's image
