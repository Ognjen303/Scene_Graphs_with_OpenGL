 ...
 * Shaders tell OpenGL how to render a previously loaded mesh
 */
public class ShaderProgram {
	 ...
	 * Function links mesh data to shader
    ...
    public void uploadMatrix4f(Matrix4f m, String target) {
    	...
    	// returns an int that represents the location of a specific uniform variable
		int location = glGetUniformLocation(getHandle(), target);
		
		FloatBuffer buffer = BufferUtils.createFloatBuffer(16);
		m.get(buffer); // loads buffer with elements of matrix m
		
		// flUniform modifies the value of a uniform variable.
		// location of uniform variable is location
